...
function Study({ study }) {
    return (
        <tr className="study z-depth-1">
            ...
            <td><Modal type={(study.e) ? "done" : "clear"} text={study.eligibility_criteria} title="Eligibility Criteria" /></td>
            <td><Modal type={(study.b) ? "done" : "clear"} text={study.brief_summary} title="Brief Summary" /></td>
